    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            List<float> arvud = new List<float>() { 3.22f, 6.66f, 1.23f };
            ...
            string uusSisestus = "";
            while (uusSisestus != "ei soovi")
            {
                Console.Write("Kas soovid sisestada veel andmeid? kui ei, kirjuta \"ei soovi\": ");
                uusSisestus = Console.ReadLine();
                if (uusSisestus != "ei soovi")
                    arvud.Add(float.Parse(uusSisestus));
            }
