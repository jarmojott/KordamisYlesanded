namespace _3_Ilmaprognoos_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int päevadeKogus = sisestaTäisArv("Mitme päeva infot sa sisestada tahad: ");
            int nädalapäevaNr = sisestaNädalapäevaTunnus("Mis nädalapäevast andmeid sisetada soovid: ");
            ...
            Console.WriteLine("Kuva andmed välja:");
                    ...
                    case "l":
                        ...
                        foreach (var konto in andmebaas)
                        {
                            if (konto[0] == kasutajaNimi && konto[2] == parool)
                            {
                                ...
                                sisestaTäisArv("Mitme päeva infot sa sisestada tahad: ");
                            }
                        }
